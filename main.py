...
def create_gradient_with_icon(width, height, color1, color2, icon_path):
    # Create gradient image
    base = Image.new("RGB", (width, height), color1)
    draw = ImageDraw.Draw(base)

    r1, g1, b1 = base.getpixel((0, 0))
    ...
    base.paste(icon, (10, (height - 40) // 2), icon)
...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model("D:\\Project\\cnn8grps_rad1_model.h5")
    ...
    def show_login_window(self):
        ...
        self.login_window.title("User Register")
    ...
    def load_main_ui(self):
        ...
        bg_image = Image.open("D:\\Project\\bg3.png")
        ...
        title_img = Image.open("D:\\Project\\images.jpg").resize((40, 40))
        ...
        self.panel3.place(x=230, y=580)

        self.T1 = tk.Label(self.root, text="Character :", font=("Times New Roman", 30, "bold"), bg="#f0f0f0")
        self.T1.place(x=10, y=580)

        self.panel5 = tk.Label(self.root, bg="#f0f0f0")  # Sentence
        self.panel5.place(x=200, y=652)

        self.T3 = tk.Label(self.root, text="Sentence :", font=("Times New Roman", 30, "bold"), bg="#f0f0f0")
        self.T3.place(x=10, y=652)

        self.T4 = tk.Label(self.root, text="Suggestions :", fg="red", font=("Times New Roman", 30, "bold"), bg="#f0f0f0")
        self.T4.place(x=10, y=720)

        self.b1 = tk.Button(self.root)
        self.b1.place(x=250, y=720)
        self.b2 = tk.Button(self.root)
        self.b2.place(x=450, y=720)
        self.b3 = tk.Button(self.root)
        self.b3.place(x=650, y=720)
        self.b4 = tk.Button(self.root)
        self.b4.place(x=850, y=720)

        # Generate gradient+icon image for Speak button
        speak_icon_path = "D:\\Project\\speak_icon.jpg"
        speak_img = create_gradient_with_icon(200, 60, "#FFB6A6", "#FFC9B9", speak_icon_path)

        clear_icon_path = "D:\\Project\\clear_icon.png"
        clear_img = create_gradient_with_icon(200, 60, "#E57373", "#D67F7F", clear_icon_path)

        gestures_icon_path = "D:\\Project\\gesture_icon.jpg"
        gestures_img = create_gradient_with_icon(200, 60, "#AEEEEE", "#B2DFDB", gestures_icon_path)
        

        # Create Speak button with gradient and icon
        self.speak = tk.Button(self.root, text=" Speak", font=("Courier", 20),
                               image=speak_img, compound=tk.CENTER,
                               command=self.speak_fun, fg="#333333", relief=tk.RAISED, bd=10)
        self.speak.image = speak_img  # Prevent image from being garbage collected
        self.speak.place(x=1200, y=200)

        self.clear = tk.Button(self.root, text=" Clear", font=("Courier", 20),
                               image=clear_img, compound=tk.CENTER,
                               command=self.clear_fun, fg="#2E2E2E", relief=tk.RAISED, bd=10)
        self.clear.image = clear_img  # Prevent image from being garbage collected
        self.clear.place(x=1200, y=300)

        self.view = tk.Button(self.root, text=" View ", font=("Courier", 20),
                              image=gestures_img, compound=tk.CENTER,
                              command=self.view_pic, fg="#263238", relief=tk.RAISED, bd=10)
        self.view.image = gestures_img  # Prevent image from being garbage collected
        self.view.place(x=1200, y=400)
        ...
        try:
            ...
            if cv2image.any:
                ...
                if hands[0]:
                    ...
                    white = cv2.imread("D:\\Project\\white.jpg")
    ...
    def view_pic(self):
        messagebox.showinfo("Gesture Info", "Show gesture image window")
    # Create a new window to show the image
        img_window = tk.Toplevel(self.root)
        img_window.title("View Image")

    # Load the image using PIL
        img = Image.open("D:\\Project\\gesture.jpeg")
        img = img.resize((400, 400))  # Optional: Resize image
